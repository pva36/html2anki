...
from html2anki import html_file_to_list, strip_list_of_flashcards, \
                        list_to_basic_n_cloze, create_html_template
...
def main():
    ...
    list_of_flashcards_stripped = strip_list_of_flashcards(list_of_flashcards,
                                                           True)
    ...
    list_of_basic, list_of_cloze = list_to_basic_n_cloze(list_of_flashcards_stripped)
